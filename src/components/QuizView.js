...
class QuizView extends Component {
  ...
  getNextQuestion = () => {
    ...
    if (this.state.currentQuestion.id) {
      previousQuestions.push(parseInt(this.state.currentQuestion.id));
    }
    $.ajax({
      ...
      data: JSON.stringify({
        ...
        quizCategoryId: parseInt(this.state.quizCategory.id) + 1,
        quizCategoryType: this.state.quizCategory.type,
      }),
      xhrFields: {
